...
import com.example.admin.myapplication.Net.ApiService;
...
public class ApiModule {
    ...
    @Provides
    @Singleton
    public ApiManager provideApiManager(Application app, ApiService githubApiService) {
        return new ApiManager(githubApiService,app);
    }
